    ...
    return (
        <>
            <div className='flex justify-evenly mt-3 text-2xl font-bold '>
                <div className='h-screen bg-green-600   w-1/3 text-center pt-4' onDragOver={onDragOver} onDrop={(e) => {
                    onDrop(e, "ToDo")
                }}>
                ...
                <div className='h-screen bg-orange-500 w-1/3 text-center pt-4' onDragOver={onDragOver} onDrop={(e) => {
                ...
                <div className='h-screen bg-red-600 w-1/3 text-center pt-4' onDragOver={onDragOver} onDrop={(e) => {
                    onDrop(e, "Done")
                }}>
