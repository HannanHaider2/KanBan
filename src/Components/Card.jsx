    ...
    return (
        <>
            <div className="block rounded-lg bg-white p-6 ml-12 mr-11 w-58 mb-2 border border-3-black">
                ...
                <div>
                    <button className="bg-red-800 text-white p-3 rounded-xl mr-1" onClick={() => Delete(task)}>Delete</button>
                    <button className="bg-lime-700 text-white p-3 rounded-xl" onClick={() => Update(task)} >Update</button>
                </div>
            </div>
        </>
    );
